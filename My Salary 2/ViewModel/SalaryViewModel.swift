...
class SalaryViewModel : ObservableObject {
    ...
    @Published var salaryInputData : SalaryModel = SalaryModel(basicSalary: "", numOfdayInFeild: "", numOfHolydaysHour: "", numOfNoarmalHours: "", feildbonus: "", advancepremium: "", familyNum: "", numOfyears: "")
    ...
    func calculatSalary(){
        ...
        // الضمان الاجتماعي
        let socialSecurity = (NumOfyears >= 35) ? 0 : (BasicSalary + overtime + fieldbonus ) * (3.75/100)
        
        // التضامن الاجتماعي
        let socialSolidarity = (NumOfyears >= 35) ? 0 : (BasicSalary + overtime + fieldbonus ) * (1/100)
        
        // ضريبة الجهاد
        let jihadTax = (BasicSalary + overtime + fieldbonus - socialSecurity - socialSolidarity) * 3/100
        ...
        //        المرتب
        let salary = BasicSalary + fieldbonus + overtime - socialSecurity - socialSolidarity
        ...
        let netSalary = BasicSalary + fieldbonus + overtime - ( Advancepremium + totalDiscount ) + NumOfyears
